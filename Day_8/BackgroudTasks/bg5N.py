...
EMAIL_CONFIG = {
    ...
    'smtp_port': 587,
    'sender_email': 'vijayamurugan27.com',  # CHANGE TO YOUR EMAIL
    # 'sender_password': 'your-app-password'  # CHANGE TO YOUR APP PASSWORD
    # 'sender_password': 'zqca gsfr wcar bqwe'  # CHANGE TO YOUR APP PASSWORD
...
class EmailTaskManager:
    ...
    def _send_bulk_emails(self, task_id: str, subject: str, message: str):
        ...
        try:
            ...
            flash(f'Starting to send emails to {total_emails} recipients...', 'info')
            ...
            flash(f'Email sending completed! Sent {success_count}/{total_emails} emails successfully.', 'success')
...
def start_email_task():
    ...
    try:
        ...
        flash('Bulk email task started successfully!', 'success')
        return redirect('/')
...
if __name__ == "__main__":
    ...
    print("⚠️  MAKE SURE TO UPDATE EMAIL_CONFIG WITH YOUR CREDENTIALS")
    print("🔧 Configuration needed:")
    print(f"   - SMTP Server: {EMAIL_CONFIG['smtp_server']}")
    print(f"   - Your Email: {EMAIL_CONFIG['sender_email']}")
    print(f"   - Your Password: {EMAIL_CONFIG['sender_password']}")
